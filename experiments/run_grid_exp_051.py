"""
Grid Experiment #051: Fashion-MNIST with Conv-MLP Hybrid (20k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #051".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_051_fashion_mnist_20000steps_conv_mlp_tanh_full_lpl"
