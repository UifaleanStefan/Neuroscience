"""
Grid Experiment #010: LPL Baseline Run (3-Layer MLP, Extended Training)

Configuration:
- Dataset: Synthetic Shapes
- Training steps: 5,000 (extended from Run #9)
...
- Seed: 42 (matches Run #9)

This run is identical to Run #9 except for training length (5000 vs 1000 steps).
"""
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #010".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_010_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
