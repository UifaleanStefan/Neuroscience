"""
Grid Experiment #009: LPL Baseline Run (3-Layer MLP)
...
This run tests a 3-layer hierarchical LPL architecture.
"""
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #009".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_009_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
