"""
Grid Experiment #047: Fashion-MNIST with 3-layer MLP (50k steps, long training)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #047".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_047_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
