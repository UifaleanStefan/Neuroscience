"""
Grid Experiment #068: CIFAR-10 with Conv-MLP Hybrid (20k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #068".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_068_cifar10_20000steps_conv_mlp_tanh_full_lpl"
