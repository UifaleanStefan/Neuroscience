"""
Grid Experiment #082: STL-10 with Conv-MLP Hybrid (1k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #082".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_082_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
