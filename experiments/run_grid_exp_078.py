"""
Grid Experiment #078: STL-10 with 3-layer MLP (1k steps)

Configuration:
- Dataset: STL-10 (RGB, 96x96 images, flattened to 27648)
- Training steps: 1,000
- Architecture: 3-layer MLP (27648 → 128 → 64 → 32 units)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #078".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_078_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
