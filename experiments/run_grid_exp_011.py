"""
Grid Experiment #011: LPL Baseline Run (3-Layer MLP, Extended Training)

Configuration:
- Dataset: Synthetic Shapes
- Training steps: 10,000 (extended from Run #10)
...
- Seed: 42 (matches Run #9 and #10)

This run is identical to Run #10 except for training length (10000 vs 5000 steps).
"""
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #011".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_011_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
