"""
Grid Experiment #032: MNIST with Conv-MLP Hybrid (10k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #032".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_032_mnist_10000steps_conv_mlp_tanh_full_lpl"
