"""
Grid Experiment #064: CIFAR-10 with 3-layer MLP (50k steps, long training)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #064".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_064_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
