"""
Grid Experiment #044: Fashion-MNIST with 3-layer MLP (1k steps)

Configuration:
- Dataset: Fashion-MNIST (grayscale, 28x28 images, flattened to 784)
- Training steps: 1,000
- Architecture: 3-layer MLP (784 → 128 → 64 → 32 units)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #044".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_044_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
