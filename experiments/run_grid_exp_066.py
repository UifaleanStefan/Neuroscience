"""
Grid Experiment #066: CIFAR-10 with Conv-MLP Hybrid (5k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #066".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_066_cifar10_5000steps_conv_mlp_tanh_full_lpl"
