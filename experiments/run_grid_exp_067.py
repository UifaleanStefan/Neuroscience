"""
Grid Experiment #067: CIFAR-10 with Conv-MLP Hybrid (10k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #067".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_067_cifar10_10000steps_conv_mlp_tanh_full_lpl"
