"""
Grid Experiment #042: Fashion-MNIST with 2-layer MLP (10k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #042".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_042_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
