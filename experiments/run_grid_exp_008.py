"""
Grid Experiment #008: LPL Baseline Run (2-Layer MLP, Extended Training - Long Regime)

Configuration:
- Dataset: Synthetic Shapes
- Training steps: 50,000 (extended from Run #7)
...
- Seed: 42 (matches Run #5, #6, and #7)

This run is identical to Run #7 except for training length (50000 vs 10000 steps).
"""
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #008".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_008_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
