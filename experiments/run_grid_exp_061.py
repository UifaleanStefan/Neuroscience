"""
Grid Experiment #061: CIFAR-10 with 3-layer MLP (1k steps)

Configuration:
- Dataset: CIFAR-10 (RGB, 32x32 images, flattened to 3072)
- Training steps: 1,000
- Architecture: 3-layer MLP (3072 → 128 → 64 → 32 units)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #061".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_061_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
