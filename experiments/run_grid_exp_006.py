"""
Grid Experiment #006: LPL Baseline Run (2-Layer MLP, Extended Training)

Configuration:
- Dataset: Synthetic Shapes
- Training steps: 5,000 (extended from Run #5)
...
- Seed: 42 (matches Run #5)

This run is identical to Run #5 except for training length (5000 vs 1000 steps).
"""
...
def main():
    ...
    EXPERIMENT_CONFIG = {
        ...
        'steps': 5000,  # Changed to 5000 steps
    ...
    print("="*70)
    print("GRID EXPERIMENT #006".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_006_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
