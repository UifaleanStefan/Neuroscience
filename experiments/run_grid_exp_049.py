"""
Grid Experiment #049: Fashion-MNIST with Conv-MLP Hybrid (5k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #049".center(70))
    print("="*70)
    ...
    output_dir = output_base / "run_049_fashion_mnist_5000steps_conv_mlp_tanh_full_lpl"
