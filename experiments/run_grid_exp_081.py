"""
Grid Experiment #081: STL-10 with 3-layer MLP (50k steps, long training)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #081".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_081_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
