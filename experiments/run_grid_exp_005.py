"""
Grid Experiment #005: LPL Baseline Run (2-Layer MLP)
...
This run is identical to Run #1 except for architecture (2-layer vs 1-layer).
"""
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #005".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_005_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
