"""
Grid Experiment #074: STL-10 with 2-layer MLP (1k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #074".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_074_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
