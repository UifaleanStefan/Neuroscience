"""
Grid Experiment #053: CIFAR-10 with 1-layer MLP
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #053".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_053_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
