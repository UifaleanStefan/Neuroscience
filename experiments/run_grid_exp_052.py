"""
Grid Experiment #052: Fashion-MNIST Non-LPL Baseline (Standard Backpropagation)
...
instead of local learning rules (LPL) for Fashion-MNIST dataset.
"""
...
class StandardMLP(nn.Module):
    ...
    def __init__(self, d_in: int, d_out: int):
        ...
        Args:
            d_in: Input dimension (28*28 = 784 for flattened Fashion-MNIST images)
...
def export_embeddings(model, dataset, num_samples=1000, device='cpu'):
    ...
    Args:
        ...
        dataset: FashionMNISTTemporalPairDataset
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #052".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_052_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
