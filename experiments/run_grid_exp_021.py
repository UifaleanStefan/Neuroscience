"""
Grid Experiment #021: MNIST with 1-layer MLP (50k steps)
...
def main():
    ...
    print("="*70)
    print("GRID EXPERIMENT #021".center(70))
    print("="*70)
    ...
    output_dir = output_base / f"run_021_{EXPERIMENT_CONFIG['dataset']}_{EXPERIMENT_CONFIG['steps']}steps_{EXPERIMENT_CONFIG['architecture']}_{EXPERIMENT_CONFIG['activation']}_{EXPERIMENT_CONFIG['rule']}"
